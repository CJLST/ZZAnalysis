...
# Regrouped uncertainties - The {year} part indicates those uncertainties that need to be kept uncorrelated between these datasets.
# Taken from https://gitlab.cern.ch/cms-nanoAOD/jsonpog-integration/-/merge_requests/120#9968ad259fd43c9ba2351d217c42dec468fe273f
    ...
    if era == 2022:
        if is_mc :
            if "pre_EE" in tag:
                ...
                scaleKeyRegrouped11 = [
                f"Summer22_22Sep2023_V2_MC_{label.format(year=era)}_AK4PFPuppi" for label in jes_systematics_11split
                ]
                smearKey = "JERSmear"
                ...
                scaleKeyRegrouped11 = [
                f"Summer22EE_22Sep2023_V2_MC_{label.format(year='2022EE')}_AK4PFPuppi" for label in jes_systematics_11split
                ]
                print("in jetJERC.py scaleKeyRegrouped11", scaleKeyRegrouped11)
                smearKey = "JERSmear"
    ...
    json_JERC = "/cvmfs/cms.cern.ch/rsync/cms-nanoAOD/jsonpog-integration/POG/JME/%s/jet_jerc.json.gz" % (folderKey) #/cvmfs/cms-griddata.cern.ch/cat/metadata/JME/Run3-23DSep23-Summer23BPix-NanoAODv12/2025-10-07/jet_jerc.json.gz
