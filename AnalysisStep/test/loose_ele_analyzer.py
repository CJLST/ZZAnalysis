...
process.ZZTreelooseEle.CandCollection_tle = cms.untracked.string('ZZCand')
...
process.CRZLLTreelooseEle.CandCollection_tle = cms.untracked.string('ZLLCand')
#
...
process.CRZLTreelooseEle.CandCollection_tle = cms.untracked.string('ZlCand')
#
#
#
#
process.CRZLLTree.CandCollection_tle = cms.untracked.string('ZLLCandlooseEle')
process.CRZLTree.CandCollection_tle = cms.untracked.string('ZlCandlooseEle')
