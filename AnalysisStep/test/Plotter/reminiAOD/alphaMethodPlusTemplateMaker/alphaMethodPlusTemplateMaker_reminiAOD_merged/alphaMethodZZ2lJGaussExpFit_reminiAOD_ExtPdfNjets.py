...
def alphaMethod(fs,jet,cat, minMass, parser):
    ...
    if(cat=='btag') :
      nRebin=10
      bins_alpha=[500,600,700,800,1000,1200,1500,3500]
    ...
    Shape_SR['VV'].Smooth(5)
    Shape_SB['TT'].Smooth(20)
    Shape_SR['TT'].Smooth(20)
    ...
    print 'Shape_SB_ee ',Shape_SB_ee['Data'].Integral()
    print 'Shape_SB_mumu ',Shape_SB_mumu['Data'].Integral()
    ...
    ttbarSR_norm_fs=(inputfile_fs[fs].Get("hmass_"+jet+"SR"+cat+"_VV")).Integral()
    vzSR_ws.Rebin(10)
    vzSR_ws.Smooth(10)
...
def Run():
    ...
    #alphaMethod('all','merged','', 500,parser)

    alphaMethod('ee','merged','', 500,parser)
    #alphaMethod('mumu','merged','', 500,parser)
