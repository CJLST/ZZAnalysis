...
//=====
   ...
   struct M4lMain
   {
      ...
      TString var_X_label_2mu2e = "m_{2#font[12]{mu}2#font[12]{#e}} (GeV)";
      TString var_Y_label       = "Events / 4 GeV";
      TString var_cut_label     = "";
      Int_t var_N_bin = 308;
      Float_t var_min = 70;
      Float_t var_max = 1302;
      Bool_t var_log_x = 1;
      Bool_t var_log_y = 0;
...
//===========
   ...
   struct KDvsM4lHighMass
   {
	...
	struct DVBFDECvsM4lZoomed
   {
      TString var_X_label = "m_{4#font[12]{l}} (GeV)";
      TString var_Y_label = "D_{bkg}^{VBF+dec}";
      TString var_cut_label = "";
      Int_t var_X_N_bin = 35;
      Float_t var_X_min = 100;
      Float_t var_X_max = 170;
	...
	struct DVHDECvsM4lZoomed
   {
      TString var_X_label = "m_{4#font[12]{l}} (GeV)";
      TString var_Y_label = "D_{bkg}^{VH+dec}";
      TString var_cut_label = "";
      Int_t var_X_N_bin = 35;
      Float_t var_X_min = 100;
      Float_t var_X_max = 170;
...
//===========
	...
	struct PFMET
   {
      TString var_X_label = "E_{T}^{miss} (GeV)";
	...
	struct Pt_trailing
   {
      ...
      Int_t rebinningDYTTbar = 2;
		...
		struct Eta_leading
   {
      TString var_X_label = "#eta^{Leading}";
