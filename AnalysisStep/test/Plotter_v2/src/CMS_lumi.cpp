...
//=====
   ...
   CMS_text = Form("#font[%i]{CMS}", CMS_text_font); // #scale[%.2f]{#font[%i]{Preliminary}}", CMS_text_font, extra_over_CMS_text_size, extra_text_font);
...
//=====
   ...
   latex.SetTextAlign(11);
   latex.SetTextSize(cms_text_size*t);
   CMS_text = Form("#font[%i]{CMS}", CMS_text_font); // #scale[%.2f]{#font[%i]{Preliminary 2016 + 2017 + 2018}}", CMS_text_font, extra_over_CMS_text_size, extra_text_font);
   latex.DrawLatex(l, 1-t+cms_text_offset*t, CMS_text);
}

void CMS_lumi::set_simulation( TPad* pad )
{
    ...
    latex.SetTextAlign(11);
    latex.SetTextSize(cms_text_size*t);
    CMS_text = Form("#font[%i]{CMS}", CMS_text_font); // #scale[%.2f]{#font[%i]{Simulation Preliminary}}", CMS_text_font, extra_over_CMS_text_size, extra_text_font);
