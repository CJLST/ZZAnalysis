LHE_DecayProbabilities_MCFM = [
   ...
   "Name:SampleHypothesisMCFM Alias:<Name> Process:bkgZZ_SMHiggs Production:ZZGG MatrixElement:MCFM Couplings:kappa_top=1,0;kappa_bot=1,0;ghz1=3.1260052406,0;ghz1_prime2=-18511.9216941165,0 hmass:125 hwidth:0.0407 Cluster:NoInitialQ isGen:1 NoBranch:1", # Hide this branch
