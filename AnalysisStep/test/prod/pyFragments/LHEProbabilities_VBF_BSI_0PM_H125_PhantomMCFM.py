LHE_Probabilities_MCFM = [
   "Name:SampleHypothesisMCFM Alias:<Name> Process:bkgZZ_SMHiggs Production:JJEW MatrixElement:MCFM Couplings:ghz1=1,0 hmass:125 hwidth:0.00407 Cluster:BestLOAssociatedVBF isGen:1 NoBranch:1",
