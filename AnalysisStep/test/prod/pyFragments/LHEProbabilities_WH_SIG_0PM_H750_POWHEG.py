...
LHE_Probabilities_MCFM = [
   "Name:SampleHypothesisMCFM Alias:<Name> Process:HSMHiggs Production:Had_WH_S MatrixElement:MCFM Couplings:ghz1=1,0 hmass:750 Cluster:BestNLOWHApproximation isGen:1 NoBranch:1",
...
LHE_DecayProbabilities_SpinZero_JHUGen = [
   "Name:Dec_SIG_ghz1_1_JHUGen Alias:SampleDecayHypothesisJHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1_prime2=10000,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghza1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghzgs1_prime2=10000,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghza2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghzgs2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghza4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghzgs4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_gha2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghgsgs2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_gha4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghgsgs4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",

   "Name:Dec_SIG_ghz1_1_ghz1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz1_prime2=10000,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghz1prime2_1E4i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz1_prime2=0,10000 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghz2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghz2_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz2=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghz4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghz4_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghz4=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs1_prime2=10000,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza1prime2_1E4i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs1_prime2=0,10000 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza2_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs2=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_ghza4_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghzgs4=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_gha2_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghgsgs2=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_gha2_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghgsgs2=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_gha4_1_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghgsgs4=1,0 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
   "Name:Dec_SIG_ghz1_1_gha4_i_JHUGen Process:SelfDefine_spin0 Production:ZZINDEPENDENT MatrixElement:JHUGen Couplings:ghz1=1,0;ghgsgs4=0,1 Options:DivideP=SampleDecayHypothesisJHUGen hmass:750 isGen:1",
]
LHE_ProdProbabilities_SpinZero_JHUGen = [
   "Name:WH_SIG_ghw1_1_JHUGen Alias:SampleProductionHypothesisJHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1_prime2=10000,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw2_1_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz2=1,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw4_1_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz4=1,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",

   "Name:WH_SIG_ghw1_1_ghw1prime2_1E4_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz1_prime2=10000,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1_1_ghw1prime2_1E4i_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz1_prime2=0,10000 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1_1_ghw2_1_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz2=1,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1_1_ghw2_i_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz2=0,1 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1_1_ghw4_1_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz4=1,0 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
   "Name:WH_SIG_ghw1_1_ghw4_i_JHUGen Process:SelfDefine_spin0 Production:Had_WH MatrixElement:JHUGen Couplings:ghz1=1,0;ghz4=0,1 Options:DivideP=SampleProductionHypothesisJHUGen hmass:750 Cluster:BestNLOWHApproximation isGen:1",
]
