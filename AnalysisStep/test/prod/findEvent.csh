...
if ( $2 == "full" ) then 
    zgrep -a -E ${EVENT}\|Closed /data3/Higgs/$SET/Chunks*/Double*/*.gz /data3/Higgs/$SET/Chunks/MuEG*/Double*/*.gz /data3/Higgs/$SET/Chunks/MuEG*/Single*/*.gz| grep -A1 $EVENT | tee info_${EVENT}.txt
endif
