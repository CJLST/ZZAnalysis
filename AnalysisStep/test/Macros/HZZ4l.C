...
void HZZ4l::Loop(Int_t channelType, const TString outputName)
{
  ...
  Float_t myp2plus_prodIndep_VAJHU      = 0.;
  Float_t myp2h4plus_gg_VAJHU  = 0.;
  Float_t myp2hminus_gg_VAJHU  = 0.;
  Float_t myp2bplus_gg_VAJHU  = 0.;
  Float_t myp2plus_gg_VAJHU      = 0.;
  Float_t myp2plus_qqb_VAJHU   = 0.;

  Float_t myp2h4plus_qqb_VAJHU = 0;
  Float_t myp2h4plus_prodIndep_VAJHU = 0;
  ...
  Float_t myphjj_VAJHU_highestPTJets = 0.;
  Float_t mypvbf_VAJHU_highestPTJets = 0.;
  Float_t myphjj_VAJHU_highestPTJets_up = 0.;
  Float_t mypvbf_VAJHU_highestPTJets_up = 0.;
  Float_t myphjj_VAJHU_highestPTJets_dn = 0.;
  Float_t mypvbf_VAJHU_highestPTJets_dn = 0.;
  Float_t myphjj_VAJHU_bestDjet = 0.;
  Float_t mypvbf_VAJHU_bestDjet = 0.;
  Float_t myphjj_VAJHU_bestDjet_up = 0.;
  Float_t mypvbf_VAJHU_bestDjet_up = 0.;
  Float_t myphjj_VAJHU_bestDjet_dn = 0.;
  Float_t mypvbf_VAJHU_bestDjet_dn = 0.;
  ...
  Float_t myp0plus_zz_0hplus_zgs_VAJHU=0.;
  Float_t myp0plus_zz_0hplus_gsgs_VAJHU=0.;
  Float_t myp0plus_zz_0minus_zgs_VAJHU=0.;
  Float_t myp0plus_zz_0minus_gsgs_VAJHU=0.;
  Float_t myp0hplus_zgs_VAJHU=0.;
  Float_t myp0hplus_gsgs_VAJHU=0.;
  Float_t myp0minus_zgs_VAJHU=0.;
  Float_t myp0minus_gsgs_VAJHU=0.;
  //Jet variables
  ...
  SelTree.Branch("p2plus_prodIndep_VAJHU",&myp2plus_prodIndep_VAJHU,"p2plus_prodIndep_VAJHU/F");
  SelTree.Branch("p2h4plus_gg_VAJHU",&myp2h4plus_gg_VAJHU,"p2h4plus_gg_VAJHU/F");
  SelTree.Branch("p2hminus_gg_VAJHU",&myp2hminus_gg_VAJHU,"p2hminus_gg_VAJHU/F");
  SelTree.Branch("p2bplus_gg_VAJHU",&myp2bplus_gg_VAJHU,"p2bplus_gg_VAJHU/F");
  SelTree.Branch("p2plus_gg_VAJHU",&myp2plus_gg_VAJHU,"p2plus_gg_VAJHU/F");
  SelTree.Branch("p2plus_qqb_VAJHU",&myp2plus_qqb_VAJHU,"p2plus_qqb_VAJHU/F");

  SelTree.Branch("p2h4plus_qqb_VAJHU", &myp2h4plus_qqb_VAJHU, "p2h4plus_qqb_VAJHU/F");
  SelTree.Branch("p2h4plus_prodIndep_VAJHU", &myp2h4plus_prodIndep_VAJHU, "p2h4plus_prodIndep_VAJHU/F");
  ...
  SelTree.Branch("p2h2plus_qqb_VAJHU", &myp2h2plus_qqb_VAJHU, "p2h2plus_qqb_VAJHU/F");
  ...
  SelTree.Branch("p2h3plus_qqb_VAJHU", &myp2h3plus_qqb_VAJHU, "p2h3plus_qqb_VAJHU/F");
  ...
  SelTree.Branch("p2h6plus_qqb_VAJHU", &myp2h6plus_qqb_VAJHU, "p2h6plus_qqb_VAJHU/F");
  ...
  SelTree.Branch("p2h7plus_qqb_VAJHU", &myp2h7plus_qqb_VAJHU, "p2h7plus_qqb_VAJHU/F");
  ...
  SelTree.Branch("p2h9minus_qqb_VAJHU", &myp2h9minus_qqb_VAJHU, "p2h9minus_qqb_VAJHU/F");
  ...
  SelTree.Branch("p2h10minus_qqb_VAJHU", &myp2h10minus_qqb_VAJHU, "p2h10minus_qqb_VAJHU/F");
  ...
  SelTree.Branch("phjj_VAJHU_highestPTJets",&myphjj_VAJHU_highestPTJets,"phjj_VAJHU_highestPTJets/F");
  SelTree.Branch("pvbf_VAJHU_highestPTJets",&mypvbf_VAJHU_highestPTJets,"pvbf_VAJHU_highestPTJets/F");
  SelTree.Branch("phjj_VAJHU_highestPTJets_up",&myphjj_VAJHU_highestPTJets_up,"phjj_VAJHU_highestPTJets_up/F");
  SelTree.Branch("pvbf_VAJHU_highestPTJets_up",&mypvbf_VAJHU_highestPTJets_up,"pvbf_VAJHU_highestPTJets_up/F");
  SelTree.Branch("phjj_VAJHU_highestPTJets_dn",&myphjj_VAJHU_highestPTJets_dn,"phjj_VAJHU_highestPTJets_dn/F");
  SelTree.Branch("pvbf_VAJHU_highestPTJets_dn",&mypvbf_VAJHU_highestPTJets_dn,"pvbf_VAJHU_highestPTJets_dn/F");
  SelTree.Branch("phjj_VAJHU_bestDjet",&myphjj_VAJHU_bestDjet,"phjj_VAJHU_bestDjet/F");
  SelTree.Branch("pvbf_VAJHU_bestDjet",&mypvbf_VAJHU_bestDjet,"pvbf_VAJHU_bestDjet/F");
  SelTree.Branch("phjj_VAJHU_bestDjet_up",&myphjj_VAJHU_bestDjet_up,"phjj_VAJHU_bestDjet_up/F");
  SelTree.Branch("pvbf_VAJHU_bestDjet_up",&mypvbf_VAJHU_bestDjet_up,"pvbf_VAJHU_bestDjet_up/F");
  SelTree.Branch("phjj_VAJHU_bestDjet_dn",&myphjj_VAJHU_bestDjet_dn,"phjj_VAJHU_bestDjet_dn/F");
  SelTree.Branch("pvbf_VAJHU_bestDjet_dn",&mypvbf_VAJHU_bestDjet_dn,"pvbf_VAJHU_bestDjet_dn/F");
  ...
  SelTree.Branch("p0plus_zz_0hplus_zgs_VAJHU",    &myp0plus_zz_0hplus_zgs_VAJHU,    "p0plus_zz_0hplus_zgs_VAJHU/F");
  SelTree.Branch("p0plus_zz_0hplus_gsgs_VAJHU",    &myp0plus_zz_0hplus_gsgs_VAJHU,    "p0plus_zz_0hplus_gsgs_VAJHU/F");
  SelTree.Branch("p0plus_zz_0minus_zgs_VAJHU", &myp0plus_zz_0minus_zgs_VAJHU, "p0plus_zz_0minus_zgs_VAJHU/F");
  SelTree.Branch("p0plus_zz_0minus_gsgs_VAJHU", &myp0plus_zz_0minus_gsgs_VAJHU, "p0plus_zz_0minus_gsgs_VAJHU/F");
  SelTree.Branch("p0hplus_zgs_VAJHU",    &myp0hplus_zgs_VAJHU,     "p0hplus_zgs_VAJHU/F");
  SelTree.Branch("p0hplus_gsgs_VAJHU",   &myp0hplus_gsgs_VAJHU,   "p0hplus_gsgs_VAJHU/F");
  SelTree.Branch("p0minus_zgs_VAJHU", &myp0minus_zgs_VAJHU, "p0minus_zgs_VAJHU/F");
  SelTree.Branch("p0minus_gsgs_VAJHU",&myp0minus_gsgs_VAJHU,"p0minus_gsgs_VAJHU/F");
...
//      TLorentzVector momH = m[0] + m[1] + m[2] + m[3]; // Withouth FSR, do not use
      ...
      myp2plus_prodIndep_VAJHU = p2plus_prodIndep_VAJHU->at(nH);
      myp2plus_gg_VAJHU = p2plus_gg_VAJHU->at(nH);
      myp2plus_qqb_VAJHU = p2plus_qqb_VAJHU->at(nH);
      myp2h4plus_gg_VAJHU = p2h4plus_gg_VAJHU->at(nH);
      myp2hminus_gg_VAJHU = p2hminus_gg_VAJHU->at(nH);
      myp2bplus_gg_VAJHU = p2bplus_gg_VAJHU->at(nH);

 			myp2h4plus_qqb_VAJHU =          p2h4plus_qqb_VAJHU ->at(nH);           
 			myp2h4plus_prodIndep_VAJHU =    p2h4plus_prodIndep_VAJHU ->at(nH);     
      ...
      myphjj_VAJHU_highestPTJets = phjj_VAJHU_highestPTJets->at(nH);
      mypvbf_VAJHU_highestPTJets = pvbf_VAJHU_highestPTJets->at(nH);
      myphjj_VAJHU_highestPTJets_up = phjj_VAJHU_highestPTJets_up->at(nH);
      mypvbf_VAJHU_highestPTJets_up = pvbf_VAJHU_highestPTJets_up->at(nH);
      myphjj_VAJHU_highestPTJets_dn = phjj_VAJHU_highestPTJets_dn->at(nH);
      mypvbf_VAJHU_highestPTJets_dn = pvbf_VAJHU_highestPTJets_dn->at(nH);
      myphjj_VAJHU_bestDjet = phjj_VAJHU_bestDjet->at(nH);
      mypvbf_VAJHU_bestDjet = pvbf_VAJHU_bestDjet->at(nH);
      myphjj_VAJHU_bestDjet_up = phjj_VAJHU_bestDjet_up->at(nH);
      mypvbf_VAJHU_bestDjet_up = pvbf_VAJHU_bestDjet_up->at(nH);
      myphjj_VAJHU_bestDjet_dn = phjj_VAJHU_bestDjet_dn->at(nH);
      mypvbf_VAJHU_bestDjet_dn = pvbf_VAJHU_bestDjet_dn->at(nH);
      ...
      mypg1g2_VAJHU=     pg1g2_VAJHU->at(nH);     
  		myp0plus_zz_0hplus_zgs_VAJHU=    p0plus_zz_0hplus_zgs_VAJHU->at(nH);
  		myp0plus_zz_0hplus_gsgs_VAJHU=    p0plus_zz_0hplus_gsgs_VAJHU->at(nH);
  		myp0plus_zz_0minus_zgs_VAJHU= p0plus_zz_0minus_zgs_VAJHU->at(nH);
  		myp0plus_zz_0minus_gsgs_VAJHU= p0plus_zz_0minus_gsgs_VAJHU->at(nH);
  		myp0hplus_zgs_VAJHU=    p0hplus_zgs_VAJHU->at(nH);
  		myp0hplus_gsgs_VAJHU=   p0hplus_gsgs_VAJHU->at(nH);
  		myp0minus_zgs_VAJHU= p0minus_zgs_VAJHU->at(nH);
  		myp0minus_gsgs_VAJHU=p0minus_gsgs_VAJHU->at(nH);
