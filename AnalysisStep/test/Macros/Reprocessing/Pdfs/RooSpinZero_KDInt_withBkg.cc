#include "Riostream.h" 
#include "RooSpinZero_KDInt_withBkg.h" 
...
ClassImp(RooSpinZero_KDInt_withBkg) 

  RooSpinZero_KDInt_withBkg::RooSpinZero_KDInt_withBkg(const char *name, const char *title, 
				       RooAbsReal& _kd,
				       RooAbsReal& _kdint,
				       RooAbsReal& _fepspr,
				       RooAbsReal& _mu,
 ...
 { 
  if (histos.size()!=3){
    coutE(InputArguments) << "RooSpinZero_KDInt_withBkg::RooSpinZero_KDInt_withBkg(" << GetName() 
...
*/ }
 ...
 RooSpinZero_KDInt_withBkg::RooSpinZero_KDInt_withBkg(const RooSpinZero_KDInt_withBkg& other, const char* name) :  
 ...
 double RooSpinZero_KDInt_withBkg::evaluate() const 
 { 
...
int RooSpinZero_KDInt_withBkg::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const
{
...
double RooSpinZero_KDInt_withBkg::analyticalIntegral(Int_t code, const char* /*rangeName*/) const
{
