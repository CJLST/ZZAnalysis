#include "Riostream.h" 
#include "RooSpinZero_KD_fepspr_withBkg.h" 
...
ClassImp(RooSpinZero_KD_fepspr_withBkg) 

  RooSpinZero_KD_fepspr_withBkg::RooSpinZero_KD_fepspr_withBkg(const char *name, const char *title, 
				       RooAbsReal& _kd,
				       RooAbsReal& _fepspr,
				       RooAbsReal& _mu,
					   vector<TH1F*>& _histos,
 ...
 { 
  if (histos.size()!=3){
    coutE(InputArguments) << "RooSpinZero_KD_fepspr_withBkg::RooSpinZero_KD_fepspr_withBkg(" << GetName() 
 ...
 RooSpinZero_KD_fepspr_withBkg::RooSpinZero_KD_fepspr_withBkg(const RooSpinZero_KD_fepspr_withBkg& other, const char* name) :  
 ...
 Double_t RooSpinZero_KD_fepspr_withBkg::evaluate() const 
 { 
...
Int_t RooSpinZero_KD_fepspr_withBkg::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const
{
...
Double_t RooSpinZero_KD_fepspr_withBkg::analyticalIntegral(Int_t code, const char* rangeName) const
{
  double value = 0.;
