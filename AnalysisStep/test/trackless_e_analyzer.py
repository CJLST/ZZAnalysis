...
process.ZZTreetle.CandCollection_tle = cms.untracked.string('ZZCand')
...
process.CRZLLTreetle.CandCollection_tle = cms.untracked.string('ZLLCand')
...
process.CRZLTreetle.CandCollection_tle = cms.untracked.string('ZlCand')




process.CRZLLTree.CandCollection_tle = cms.untracked.string('ZLLCandtle')
process.CRZLTree.CandCollection_tle = cms.untracked.string('ZlCandtle')
