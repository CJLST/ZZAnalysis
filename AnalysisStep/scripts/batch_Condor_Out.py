...
def batchScript( index, outfolder, remoteDir=''):
...
class MyBatchManager:
    ...
    def __init__(self):        
        ...
        self.parser_.add_option("-w", "--work-dir", dest="outputDir",
                                help="Name of the local work directory for your jobs. This directory will be created automatically.",
                                default=None)

	self.parser_.add_option("-o", "--output-dir", dest="trueOutputDir",
