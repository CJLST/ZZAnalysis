...
if ($MERGEDATA16 || $MERGEDATA17) then
...
if ($MERGEDATA16 || $MERGEDATA17) then
    ...
    if ($MERGEDATA16) hadd AllData/ZZ4lAnalysis2016.root *2017*/ZZ4lAnalysis.root >&! haddlog_${SETNAME}_mergingData.txt
    if ($MERGEDATA17) hadd AllData/ZZ4lAnalysis.root *2016*/ZZ4lAnalysis.root >&! haddlog_${SETNAME}_mergingData.txt
endif
