...
mvaFall17WeightFiles_V1_94X = cms.vstring(
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EB1_5_iso.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EB2_5_iso.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EE_5_iso.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EB1_10_iso.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EB2_10_iso.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17_V1_94X/EE_10_iso.weights.xml.gz"
    )
...
idName90 = "mvaEleID-Fall17-iso-V1_94X-wp90"
MVA_WP90 = EleMVA_WP(
    idName = idName90,
...
idName80 = "mvaEleID-Fall17-iso-V1_94X-wp80"
MVA_WP80 = EleMVA_WP(
    idName = idName80,
    mvaValueMapName = mvaValueMapName,           # map with MVA values for all particles
    mvaCategoriesMapName = mvaCategoriesMapName, # map with category index for all particles
...
idNamewpLoose = "mvaEleID-Fall17-iso-V1_94X-wpLoose"
...
idNamewpHZZ = "mvaEleID-Fall17-iso-V1_94X-wpHZZ"
MVA_WPHZZ = EleMVA_WP(
    idName = idNamewpHZZ,
    mvaValueMapName = mvaValueMapName,           # map with MVA values for all particles
    mvaCategoriesMapName = mvaCategoriesMapName, # map with category index for all particles
...
mvaEleID_Fall17_iso_V1_94X_producer_config = cms.PSet(
...
mvaEleID_Fall17_V1_94X_wpHZZ = configureVIDMVAEleID_V1( MVA_WPHZZ )
...
mvaEleID_Fall17_V1_94X_wpHZZ.isPOGApproved = cms.untracked.bool(True)
