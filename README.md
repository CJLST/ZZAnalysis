...
```
wget -O ${TMPDIR}/checkout_10X.csh https://raw.githubusercontent.com/CJLST/ZZAnalysis/200717_LegacyRun2_PAPER/checkout_10X.csh
cd $CMSSW_BASE/src
cmsenv
...
git push origin 200717_LegacyRun2_PAPER
```
